...
def django_models_json(request):
    ...
    data = serialize("json", qs, fields=('name', 'product_image','price','description'))
...
def destinations(request):
    ...
    return render(request, 'ecom/destinations.html', {'products':products,'product_count_in_cart':product_count_in_cart})
...
def add_to_cart_view(request,pk):
    ...
    response = render(request, 'ecom/destinations.html',{'products':products,'product_count_in_cart':product_count_in_cart})
